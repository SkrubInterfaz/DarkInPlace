<section id="alert" class="content">
		...
		*/
		...
		?><tr>
			...
			?></td>
                        ...
                        <td><a
                                href="index.php?action=alerts_vu&page=post&id=<?php echo $answer_liked['id_topic']; ?>&page_post=<?php echo $page; ?>&id_answer=<?php echo $answer_liked['id_answer']; ?>&likeur=<?php echo $answer_liked['pseudo_likeur']; ?>#<?php echo $answer_liked['id_answer']; ?>">
                                <?php echo $answer_liked['pseudo_likeur']; ?></a></td>
	...
	if($donnees_new['pseudo'] != $donnees_new['last_answer_pseudo'] AND $donnees_new['last_answer_pseudo'] != NULL AND $donnees_new['vu'] == 0)
	{
		...
		?><tr>
			...
			echo $donnees_new['nom']; ?></td>
                        ...
                        <td>
                            <!-- Lien + auteur de l'alerte --><a
                                href="index.php?action=alerts_rep&page=post&id=<?php echo $donnees_new['id_topic']; ?>&page_post=<?php echo $page; ?>&answer=<?php echo $bd[$reponse]['id']; ?>">Réponse
                                de <?php echo $donnees_new['last_answer_pseudo']; ?></a></td>
                    </tr>
                    <?php
	}
}
            ...
            <?php }else{
                ...
                <div class="col-md-12">
                    <div class="alert alert-danger">
                        <p>
                            Veulliez vous connecté pour accéder à cette page !
                        </p>
                    </div>
                </div>';
            } ?>
